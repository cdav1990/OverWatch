...
var SwitchBase = React14.forwardRef(function SwitchBase2(props, ref) {
  const {
    autoFocus,
    checked: checkedProp,
    checkedIcon,
...
var Checkbox = React18.forwardRef(function Checkbox2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiCheckbox"
  });
  ...
  const [RootSlot, rootSlotProps] = useSlot("root", {
    ...
    additionalProps: {
      ...
      checkedIcon: React18.cloneElement(indeterminateIcon, {
...
//# sourceMappingURL=chunk-COBO5KRB.js.map
