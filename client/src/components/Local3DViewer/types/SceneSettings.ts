...
export const DEFAULT_SCENE_SETTINGS: SceneSettings = {
  ...
  // Water defaults
  waterEnabled: true,
  waterColor: '#194987', // Darker blue for better wave contrast
  waterOpacity: 0.85,    // Slightly increased opacity
  waterWaveSpeed: 0.2,   // Increased from 0.12 to 0.2 to make wave movement more noticeable
  waterWaveScale: 2.5,   // Increased from 1.8 to 2.5 for more pronounced waves
  ...
  // NEW: Default Environment Map Settings
  environmentMap: null,
